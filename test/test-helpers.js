...
const seedDogsTable = (db, dogs) => {
	return db
		...
		.then(() =>
			...
			db.raw(`SELECT setval('dogs_id_seq', ?)`, [
	...
	return db.transaction(trx =>
      ...
      `
			...
			.then(() =>
				Promise.all([
					trx.raw(
						`ALTER SEQUENCE dogs_id_seq minvalue 0 START WITH 1`
					),
					trx.raw(
						`ALTER SEQUENCE users_id_seq minvalue 0 START WITH 1`
					),
					trx.raw(
						`ALTER SEQUENCE notes_id_seq minvalue 0 START WITH 1`
					),
					trx.raw(
						`ALTER SEQUENCE shots_id_seq minvalue 0 START WITH 1`
					),
